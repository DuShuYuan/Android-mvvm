package com.dsy.mvvm.utils.log;
...
public final class ProcessUtils {
    ...
    public static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) AppCtxKt.getAppCtx().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            PackageManager pm = AppCtxKt.getAppCtx().getPackageManager();
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(AppCtxKt.getAppCtx().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) AppCtxKt.getAppCtx().getSystemService(Context.APP_OPS_SERVICE);
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) AppCtxKt.getAppCtx()
    ...
    public static boolean isMainProcess() {
        return AppCtxKt.getAppCtx().getPackageName().equals(getCurrentProcessName());
    }
    ...
    private static String getCurrentProcessNameByAms() {
        try {
            ActivityManager am = (ActivityManager) AppCtxKt.getAppCtx().getSystemService(Context.ACTIVITY_SERVICE);
            if (am == null) return "";
            List<ActivityManager.RunningAppProcessInfo> info = am.getRunningAppProcesses();
    ...
    private static String getCurrentProcessNameByReflect() {
        String processName = "";
        try {
            Field loadedApkField = AppCtxKt.getAppCtx().getClass().getField("mLoadedApk");
            loadedApkField.setAccessible(true);
            Object loadedApk = loadedApkField.get(AppCtxKt.getAppCtx());
